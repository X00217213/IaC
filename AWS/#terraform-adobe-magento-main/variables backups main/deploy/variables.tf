...
variable "ssh_key_pair_name" {
  ...
  default     = "terraform-adobe-magento"
}
...
variable "mage_composer_username" {
  ...
  default     = "98efd97b10acbf66b2aaecb7e8e23ac8"
}
...
variable "mage_composer_password" {
  ...
  default     = "ab5621f8147cb2187c42a29c2d06d55d"
}
